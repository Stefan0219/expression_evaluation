This program is used for expression evaluation, which can be seen as a sort of extension of the NJU ics [lab](https://nju-projectn.github.io/ics-pa-gitbook/ics2021/1.5.html).
